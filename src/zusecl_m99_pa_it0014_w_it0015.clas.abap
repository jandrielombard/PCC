class ZUSECL_M99_PA_IT0014_W_IT0015 definition
  public
...
public section.
  protected section.
    ...
    types:
      begin of ty_it0014_dtls,
        subty type subty,
        begda type begda.
    types: end of ty_it0014_dtls .
    types:
      begin of ty_it0014,
        pernr type pernr_d,
        subty type subty,
    ...
    data ms_it0014_dtls type ty_it0014_dtls .
    constants mc_infty_0014 type infty value '0014' ##NO_TEXT.
    constants mc_itemid_it0014err type pyd_itemid value 'IT0014ERR' ##NO_TEXT.
...
CLASS ZUSECL_M99_PA_IT0014_W_IT0015 IMPLEMENTATION.


  method CHECK.
* For P0014 record starting in current period, a corresponding P0015 should exist .
...
* Fetch Employees Whose Birthday occurs in the period dates
    select it0014~pernr, it0014~subty, it0014~begda
        ...
        loop at ct_err_ov into ls_err_ov.
          ...
          loop at lt_sfo_tab into ls_sfo_tab.
            ...
            call method me->copy_structure_to_other
              ...
              changing
                p_struct2 = ms_it0014_dtls.

            move-corresponding ms_it0014_dtls to ms_it0014.
            move lv_pernr to ms_it0014-pernr.

* Read IT 0014 Subtype text
            call function 'HR_GET_SUBTYPE_TEXT'
              exporting
                infty               = mc_infty_0014
                subty               = ms_it0014-subty
                persnr              = ms_it0014-pernr
                begda               = ms_it0014-begda
                endda               = ms_it0014-begda
                molga               = mc_molga_nz
              importing
                stext               = ms_it0014-stext
              exceptions
                infty_not_found     = 1
                subty_not_found     = 2
...
* Implement suitable error handling here
            ...
            concatenate ms_it0014-stext  '(' ms_it0014-subty ')'
            ...
            write: ms_it0014-begda to lv_it_begda dd/mm/yyyy.
            lv_text = lv_it_begda.
            call method me->add_record_to_sfo_tab
              exporting
                iv_itemid                   = mc_itemid_it0014err
...
* Populate SFO tab for Table Save
          loop at mt_it0014 into ms_it0014
            where pernr = lv_pernr.
            move-corresponding ms_it0014 to ms_it0014_dtls.
            call method me->copy_structure_to_other
              exporting
                p_struct1 = ms_it0014_dtls
              changing
                p_struct2 = lv_char_value.

            add 1 to ls_sfo-row_id.
            ls_sfo-itemid = mc_itemid_it0014err.
