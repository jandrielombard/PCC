class zcl_m99_pa_stp_excep_rpt definition
  public
...
CLASS ZCL_M99_PA_STP_EXCEP_RPT IMPLEMENTATION.
...
* Fetch Employees IT 0006 STP data
    select it0006~pernr, it0006~subty, it0006~state, it0006~pstlz
...
* Identify Post code Errors in IT0006 fields
    loop at lt_it6_stpdata into ls_it6_stpdata.
      clear: ls_stpexc_rep.
      move: ls_it6_stpdata-pernr to ls_stpexc_rep-pernr.
