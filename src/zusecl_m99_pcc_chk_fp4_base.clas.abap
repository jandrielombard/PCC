class ZUSECL_M99_PCC_CHK_FP4_BASE definition
  public
...
CLASS ZUSECL_M99_PCC_CHK_FP4_BASE IMPLEMENTATION.
...
* Read Employees for New Zealand Payroll Areas
    if lr_pernrs_so is initial.
      call method zusecl_m99_pcc_chk_utilities=>read_payroll_area_pernr
        exporting
...
*---------------------------------------------------------------------*
    ...
    clear: mv_rfc_msg.
    receive results from function 'ZUSE_PCC_PARALLEL_TASK'
     importing
...
* Populate SAP_T custom text for Validations
    ...
    data: lt_text   type table of zuse_pcc_vtext,
          ls_text   type zuse_pcc_vtext,
...
*---------------------------------------------------------------------*
    ...
    do.
      ...
      call function 'ZUSE_PCC_PARALLEL_TASK'
