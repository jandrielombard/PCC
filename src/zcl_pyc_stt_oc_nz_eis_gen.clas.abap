class ZCL_PYC_STT_OC_NZ_EIS_GEN definition
  public
...
public section.
  ...
  constants GC_SUB_CLSNM type CLASSNAME value 'ZCL_PYC_BPC_SELECTION_OC_EIS' ##NO_TEXT.
...
CLASS ZCL_PYC_STT_OC_NZ_EIS_GEN IMPLEMENTATION.
