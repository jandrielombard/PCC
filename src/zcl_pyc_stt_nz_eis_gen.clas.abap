class ZCL_PYC_STT_NZ_EIS_GEN definition
  public
...
protected section.
  ...
  constants MC_SELECTION_CLS_EIS type PYD_PAR_TYPE value 'ZCL_PYC_BPC_SELECTION_EIS' ##NO_TEXT.
...
CLASS ZCL_PYC_STT_NZ_EIS_GEN IMPLEMENTATION.
...
* Assign Report, Selection and Log Classes
    ...
    ls_dto-sel_rt = me->mc_selection_cls_eis.
