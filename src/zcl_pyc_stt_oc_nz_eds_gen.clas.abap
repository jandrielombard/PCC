class ZCL_PYC_STT_OC_NZ_EDS_GEN definition
  public
...
public section.
  ...
  constants GC_SUB_CLSNM type CLASSNAME value 'ZCL_PYC_BPC_SELECTION_OC_EDS' ##NO_TEXT.
...
CLASS ZCL_PYC_STT_OC_NZ_EDS_GEN IMPLEMENTATION.
