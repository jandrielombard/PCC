"Name: \TY:CL_PYD_INST_RT\IN:IF_PYD_INST_RT\ME:INSTANCE_EXECUTE\SE:END\EI
ENHANCEMENT 0 ZHRAUPY_EI_CHK_EXE_MSG.
...
*---------------------------------------------------------------------------------------------*
* Report Check Execution End time
  GET TIME.
  MESSAGE s009(ZHRPY_PCC_MSG) WITH iv_id sy-datum sy-uzeit.
