class zcl_m99_py_cancjobs_employees definition
  public
  ...
  protected section.
    ...
    data mt_cancjob_data type zcl_m99_pcc_ehiupdate=>tty_emplist.
    data ms_cancjob_data type zcl_m99_pcc_ehiupdate=>ty_emplist.
...
CLASS ZCL_M99_PY_CANCJOBS_EMPLOYEES IMPLEMENTATION.
        ...
        loop at ct_err_ov into ls_err_ov.
          ...
          loop at lt_sfo_tab_temp into data(ls_sfo_tab_temp).
            if ls_sfo_tab_temp-itemid eq mc_itemid_cancjob.
              ...
              call method zcl_m99_pcc_utilities=>get_pernr_payroll_runtime
                exporting
                  iv_pernr       = lv_pernr
                  io_res_context = io_res_context
                importing
              ...
              if not ls_pay_runtime-rundt is initial.
                ...
                message i059(zhrpy_pcc_msg) into lv_value_string.
              endif.
              lv_text = text-005.
              call method me->add_record_to_sfo_tab
                exporting
