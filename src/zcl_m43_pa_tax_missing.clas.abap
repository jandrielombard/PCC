...
protected section.
  ...
  constants MC_ITEMID_NZTAX type PYD_S_RDSFO_EXT-ITEMID value 'NZTAX' ##NO_TEXT.
...
* Identify Employees with blank tax code
    loop at lt_all_it0313 into ls_it0313.
* Clear from the Employee main list
      delete lt_pernr where dct_pernr = ls_it0313-pernr.
      " Check for blanck tax code
      if ls_it0313-taxcd is initial.
        append ls_it0313 to lt_err_it0313.
      endif.
    endloop.

* Add all Employees with blank tax code
    sort lt_err_it0313.
...
* Add all Employees with missing tax code records
