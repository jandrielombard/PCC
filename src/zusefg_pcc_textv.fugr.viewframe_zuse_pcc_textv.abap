*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZUSE_PCC_TEXTV
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZUSE_PCC_TEXTV      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZUSE_PCC_TEXTV'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZUSE_PCC_TEXTV_EXTRACT
TOTAL = ZUSE_PCC_TEXTV_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZUSE_PCC_TEXTV'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZUSE_PCC_TEXTV-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZUSE_PCC_TEXTV_EXTRACT
TOTAL = ZUSE_PCC_TEXTV_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZUSE_PCC_TEXTV-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZUSE_PCC_TEXTV'
...
TOTAL = ZUSE_PCC_TEXTV_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZUSE_PCC_TEXTV-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZUSE_PCC_TEXTV-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZUSE_PCC_TEXTV'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZUSE_PCC_TEXTV-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZUSE_PCC_TEXTV_EXTRACT
TOTAL = ZUSE_PCC_TEXTV_TOTAL
