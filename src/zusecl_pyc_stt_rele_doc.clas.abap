class ZUSECL_PYC_STT_RELE_DOC definition
  public
  inheriting from CL_PYC_STT_RELE_DOC
  final
  create public .
...
CLASS ZUSECL_PYC_STT_RELE_DOC IMPLEMENTATION.
  ...
  method FP3_BPC_DET_RT_GET_LIST.
    ...
    ls_dto-sel_rt   = 'ZUSECL_PYC_BPC_SEL_PSREL_RUNID'.
