...
data: gt_ps_wtg_dv type table of zhrpy_ps_wtg_dv,
      gs_ps_wtg_dv type zhrpy_ps_wtg_dv.
...
types: ty_s_alvc type zhrpy_ps_wtg_dv.
...
form set_fieldcat_psid .
  ...
  call function 'REUSE_ALV_FIELDCATALOG_MERGE'
    exporting
      ...
      i_structure_name       = 'ZHRPY_PS_WTG_DV'
    changing
  ...
  loop at lt_fieldcat into ls_fieldcat.
    ...
    gs_fieldcatalog-ref_table = 'ZHRPY_PS_WTG_DV'.
    append gs_fieldcatalog to gt_fieldcatalog.
  endloop.
