...
* Display only employees with Cancelled status
  ...
  delete lt_emplist
   where not repro eq zcl_m99_pcc_ehiupdate=>gc_repro_status-cancelled.
...
* Display Jobs for Selection
  ...
  data ls_jobslist type zcl_m99_pcc_ehiupdate=>ty_proc_jobslist.
  data lt_emplist type zcl_m99_pcc_ehiupdate=>tty_emplist.
    ...
    while  ucom = gc_jobs.
      ...
      case hr_ret_code.
        when 1.
          ...
          call method zcl_m99_pcc_ehiupdate=>display_job_steps
            exporting
        ...
        when 2.
          ...
          delete lt_emplist
              where not repro eq zcl_m99_pcc_ehiupdate=>gc_repro_status-cancelled.
          call method zcl_m99_pcc_ehiupdate=>add_employees_to_ehitbl
            changing
