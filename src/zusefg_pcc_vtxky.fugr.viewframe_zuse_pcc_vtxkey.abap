*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZUSE_PCC_VTXKEY
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZUSE_PCC_VTXKEY     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZUSE_PCC_VTXKEY'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZUSE_PCC_VTXKEY_EXTRACT
TOTAL = ZUSE_PCC_VTXKEY_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZUSE_PCC_VTXKEY'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZUSE_PCC_VTXKEY-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZUSE_PCC_VTXKEY_EXTRACT
TOTAL = ZUSE_PCC_VTXKEY_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZUSE_PCC_VTXKEY-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZUSE_PCC_VTXKEY'
...
TOTAL = ZUSE_PCC_VTXKEY_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZUSE_PCC_VTXKEY-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZUSE_PCC_VTXKEY-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZUSE_PCC_VTXKEY'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZUSE_PCC_VTXKEY-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZUSE_PCC_VTXKEY_EXTRACT
TOTAL = ZUSE_PCC_VTXKEY_TOTAL
