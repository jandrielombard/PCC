class ZUSECL_PY_WT_COMP_BETRG_MULTI definition
  public
...
CLASS ZUSECL_PY_WT_COMP_BETRG_MULTI IMPLEMENTATION.
...
* Collect the data
    data: lo_cloned_chkobj type ref to zusecl_py_wt_comp_betrg_multi.
