report zhraurepy_pcc_dl_audit_trail.
*-----------------------------------------------------------------------*
* Program Name  : ZHRAUREPY_PCC_DL_AUDIT_TRAIL                          *
...
*    |            |         |                             |CFAK902861   *
*-----------------------------------------------------------------------*
include zhraurepy_pcc_dl_audit_tr01. " Application Class
include zhraurepy_pcc_dl_audit_tr02. " Selection
