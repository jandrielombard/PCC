class zcl_pyc_kpi_payroll_ee_count definition
  public
  ...
  protected section.
    ...
    methods get_payroll_jobs_detail
      ...
      exporting
        !et_jobnam type dmc_t_jobname_range
        !et_jobcnt type tcjrange .
    methods get_spool_for_all_jobs
      importing
        !it_jobnam type dmc_t_jobname_range
...
CLASS ZCL_PYC_KPI_PAYROLL_EE_COUNT IMPLEMENTATION.
...
* Payroll Process Statastics using bar chart
    ...
    data: lt_sel_jobnam type  dmc_t_jobname_range,
...
* Job Details
    ...
    data: ls_sel_jobnam type dmc_s_jobname_range,
