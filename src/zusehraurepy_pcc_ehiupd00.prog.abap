*&---------------------------------------------------------------------*
*& Report           : ZUSEHRAUREPY_PCC_EHIUPD00                        *
*& Tiltle           : PCC EHI Table Update for cancelled jobs Employees*
*& Transactio Code  : ZUSEHRPY_M99_EHIUPD                              *
*&                                                                     *
...
*&                                                                     *
*&---------------------------------------------------------------------*
report  zusehraurepy_pcc_ehiupd00 line-size 1023 no standard page heading.

include zusehraurepy_pcc_ehiupd_top.
include zusehraurepy_pcc_ehiupd_frm.
