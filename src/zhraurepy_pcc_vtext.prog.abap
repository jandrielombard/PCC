...
constants: gc_cluster      type vcl_name value 'ZHRPYC_PCC_VTEXT', "SM34 maintenance cluster
...
data: gt_val   type table of pyd_d_tyt,
      ...
      gt_key   type table of zhrpy_pcc_vtextk,
      gs_key   type zhrpy_pcc_vtextk,
      gv_modif.
...
if gv_modif eq gc_action.
  modify zhrpy_pcc_vtextk from table gt_key.
