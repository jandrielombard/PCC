class ZUSECL_M99_PA_IT0008_COMP_WT_P definition
  public
...
public section.
  ...
  constants MC_COMP_PERCENT type PYD_PAR_TYPE value 'Z99_COMP_PERCENT' ##NO_TEXT.
  ...
  protected section.
    ...
    data mv_comp_percentage type hrpayit_percentage.
...
CLASS ZUSECL_M99_PA_IT0008_COMP_WT_P IMPLEMENTATION.
    ...
    loop at lt_it08 into data(ls_it08).
      ...
      if lv_is_error = abap_false.
        ...
        if lv_is_error = abap_false.
          ...
          if ( + lv_bet_sum_02-ein_sum ) <> ( lv_bet_sum_01-ein_sum * ( mv_comp_percentage / 100 ) ).
            lv_is_error = abap_true.
          elseif ( + lv_bet_sum_02-bet_sum ) <> ( lv_bet_sum_01-bet_sum * ( mv_comp_percentage / 100 ) ).
            lv_is_error = abap_true.
          endif.
        endif.
      endif.
  ...
  method ERR_OV_GET_LIST.
    ...
    data: lv_comp_int_percentage type i.
      ...
      when if_pyd_fnd_types=>gcs_rdt_data_access_mode-execute.
        ...
        loop at ct_err_ov into ls_err_ov.
          ...
          loop at mt_it08_comp_wt into ls_it08_comp_wt
            ...
            move mv_comp_percentage to lv_comp_int_percentage.
            if lines( ls_it08_comp_wt-t_lgart_01 ) <= 1.
              message e043 with lv_comp_int_percentage into lv_value.
              lv_value = |{ lv_lgart_02 } amount - { ls_it08_comp_wt-bet_sum_02-bet_sum } { lv_value } { lv_lgart_01 } - { ls_it08_comp_wt-bet_sum_01-bet_sum }|.
            else.
              message e043  with lv_comp_int_percentage into lv_value.
              lv_value = |{ lv_lgart_02 } amount - { ls_it08_comp_wt-bet_sum_02-bet_sum } { lv_value } { lv_lgart_01 } - { ls_it08_comp_wt-bet_sum_01-bet_sum }|.
            endif.
...
* Read Comparison Percentage
        mv_comp_percentage =  cl_pyd_fnd_aux=>get_resp_fixed_value( iv_par_type = me->mc_comp_percent
