class ZUSECL_M99_PY_WT_DDNTK_BETRG definition
  public
...
CLASS ZUSECL_M99_PY_WT_DDNTK_BETRG IMPLEMENTATION.
...
* Collect the data
    data: lo_cloned_chkobj type ref to zusecl_m99_py_wt_ddntk_betrg.
