class ZCL_M99_PA_IT8_NEW definition
  public
...
PROTECTED SECTION.
  ...
  TYPES:
    BEGIN OF ty_data.
      INCLUDE TYPE zcl_m99_pa_it0008_comp_wt=>ty_it08.
  ...
  METHODS get_wt_to_check
    ...
    RETURNING
      VALUE(rt_wage_types) TYPE zcl_m99_pa_it0008_comp_wt=>tty_lgart .
  METHODS get_it08_in_period_and_check
    IMPORTING
      !iv_pernr              TYPE pernr_d
      !iv_pay_period_begda   TYPE begda
      !iv_pay_period_endda   TYPE endda
      !it_wage_type_to_check TYPE zcl_m99_pa_it0008_comp_wt=>tty_lgart
    RETURNING
...
CLASS ZCL_M99_PA_IT8_NEW IMPLEMENTATION.
...
*   check whether employee is active on iv_pay_period_begda and iv_pay_period_endda.
  ...
  method check.
    ...
    data: ls_output       like line of mt_output,
          ...
          ls_it08_only    type zcl_m99_pa_it0008_comp_wt=>ty_it08,
          lt_wt_to_check  type zcl_m99_pa_it0008_comp_wt=>tty_lgart.
...
*and end after end of pay period (lv_pay_period_endda_new)
    ...
    DATA: lt_data TYPE SORTED TABLE OF zcl_m99_pa_it0008_comp_wt=>ty_it08 WITH UNIQUE KEY pernr subty objps endda begda seqnr,
...
*   to the end of the active period
    ...
    IF sy-subrc = 0.
      LOOP AT lt_data INTO ls_data.
        DO zcl_m99_pa_it0008_comp_wt=>mc_number_of_wagetypes TIMES.
...
*Get pay periods for a payroll area that covers IV_IT07_BEGDA and IV_IT07_ENDDA
  ...
  METHOD get_wt_to_check.
    DATA: ls_it08_only TYPE zcl_m99_pa_it0008_comp_wt=>ty_it08.
    ls_it08_only = CORRESPONDING #( is_data ).
    zcl_m99_pa_it0008_comp_wt=>sum_of_wt(
      EXPORTING
