class ZUSECL_PY_WT_BALANCE_ANZHL_2 definition
  public
...
CLASS ZUSECL_PY_WT_BALANCE_ANZHL_2 IMPLEMENTATION.
...
* Collect the data
    data: lo_cloned_chkobj type ref to zusecl_py_wt_balance_anzhl_2.
