...
data: go_mdlog_ehiupdate type ref to zusecl_m99_pcc_mdlog_ehiupdate.
* Employee Master data Changes
data: gt_empslist type zusecl_m99_pcc_mdlog_ehiupdate=>tty_empslist,
      gs_empslist type zusecl_m99_pcc_mdlog_ehiupdate=>ty_empslist.
* Employee Payroll Area
data: gt_it0001 type zusecl_m99_pcc_mdlog_ehiupdate=>tty_it0001,
      gs_it0001 type zusecl_m99_pcc_mdlog_ehiupdate=>ty_it0001.
