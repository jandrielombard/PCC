CLASS lcl_zhraupy_ei_pcc_rep_par DEFINITION DEFERRED.
CLASS cl_pyc_bpc_report_parallel DEFINITION LOCAL FRIENDS lcl_zhraupy_ei_pcc_rep_par.
CLASS lcl_zhraupy_ei_pcc_rep_par DEFINITION.
  PUBLIC SECTION.
    CLASS-DATA obj TYPE REF TO lcl_zhraupy_ei_pcc_rep_par.  "#EC NEEDED
    DATA core_object TYPE REF TO cl_pyc_bpc_report_parallel . "#EC NEEDED
 INTERFACES  IPO_ZHRAUPY_EI_PCC_REP_PAR.
    METHODS:
      constructor IMPORTING core_object
                              TYPE REF TO cl_pyc_bpc_report_parallel OPTIONAL.
ENDCLASS.
CLASS lcl_zhraupy_ei_pcc_rep_par IMPLEMENTATION.
  METHOD constructor.
    me->core_object = core_object.
  ENDMETHOD.

  METHOD ipo_zhraupy_ei_pcc_rep_par~split_selection.
*"------------------------------------------------------------------------*
