class zcl_m99_py_wt_balance_anzhl definition
  public
...
CLASS ZCL_M99_PY_WT_BALANCE_ANZHL IMPLEMENTATION.
...
* Collect the data
    data: lo_cloned_chkobj type ref to zcl_m99_py_wt_balance_anzhl.
