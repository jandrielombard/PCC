class ZUSECL_M99_PY_WT_BALANCE_ANZHL definition
  public
...
CLASS ZUSECL_M99_PY_WT_BALANCE_ANZHL IMPLEMENTATION.
...
* Collect the data
    data: lo_cloned_chkobj type ref to zusecl_m99_py_wt_balance_anzhl.
...
* <<< End of CFAK901877 MOD001--
    ...
    endloop.
* >>> Start of CFAK901877 MOD001--
* Only want compare to occur one way to determine is alert should be raised
* LGART_01 vs LGART_02 so if emp only has LGART_02 WTs they do not care.
