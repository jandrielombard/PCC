class ZCL_M99_PY_WT_COMP_ANZHL_2_BET definition
  public
...
CLASS ZCL_M99_PY_WT_COMP_ANZHL_2_BET IMPLEMENTATION.
...
* Collect the data
    data: lo_cloned_chkobj type ref to zcl_m99_py_wt_comp_anzhl_2_bet.
