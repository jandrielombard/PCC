class ZCL_M99_PYC_STT_ASYNC_MAN_BASE definition
  public
...
CLASS ZCL_M99_PYC_STT_ASYNC_MAN_BASE IMPLEMENTATION.


  METHOD fp3_exe_det_info_get.
* redefined to allow long text in process step

    DATA: lt_text    TYPE TABLE OF zhrpy_pcc_text,
          ls_text    TYPE zhrpy_pcc_text,
