class ZCL_PYC_STT_TIME_EVALUATION definition
  public
...
protected section.
  ...
  constants MC_SELECTION_CLS type PYD_PAR_TYPE value 'ZCL_PYC_BPC_SELECTION_TE' ##NO_TEXT.
  constants MC_PARA_SELECTION_CLS type PYD_PAR_TYPE value 'ZCL_PYC_BPC_PARA_SELECTION_TE' ##NO_TEXT.
...
CLASS ZCL_PYC_STT_TIME_EVALUATION IMPLEMENTATION.
...
* Param filler(PNP or Free)
    r_result = cl_pyc_param_filler_factory=>gc_kinds-pnp_only .
