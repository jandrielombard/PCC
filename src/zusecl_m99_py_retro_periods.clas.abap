class ZUSECL_M99_PY_RETRO_PERIODS definition
  public
...
CLASS ZUSECL_M99_PY_RETRO_PERIODS IMPLEMENTATION.
...
* Collect the data
      data: lo_cloned_chkobj type ref to zusecl_m99_py_retro_periods.
