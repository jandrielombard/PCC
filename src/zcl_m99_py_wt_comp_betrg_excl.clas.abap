class zcl_m99_py_wt_comp_betrg_excl definition
  public
  ...
  protected section.
    ...
    data mv_amt_low_01 type pranz .
    data mv_amt_low_02 type pranz .
    data mv_amt_low_03 type pranz .
    data mv_amt_high_01 type pranz .
    data mv_amt_high_02 type pranz .
    data mv_amt_high_03 type pranz .
...
CLASS ZCL_M99_PY_WT_COMP_BETRG_EXCL IMPLEMENTATION.
...
* Collect the data
    data: lo_cloned_chkobj type ref to zcl_m99_py_wt_comp_betrg_excl.
