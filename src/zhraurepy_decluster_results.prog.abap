*-----------------------------------------------------------------------*
* Program Name  : ZHRAUREPY_DECLUSTER_RESULTS
...
*-----------------------------------------------------------------------*
*11-Oct-2021| 1168007      |Initial creation              |CFAK900994   *
*           |              |                              |             *
*           |              |                              |             *
*-----------------------------------------------------------------------*
report zhraurepy_decluster_results.
...
data: gt_config type table of zhrpy_pcc_tables with header line.
...
start-of-selection.
  ...
  "fetch the config
  select * into table gt_config from zhrpy_pcc_tables.
