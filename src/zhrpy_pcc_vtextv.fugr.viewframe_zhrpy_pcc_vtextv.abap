*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZHRPY_PCC_VTEXTV
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZHRPY_PCC_VTEXTV    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZHRPY_PCC_VTEXTV'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZHRPY_PCC_VTEXTV_EXTRACT
TOTAL = ZHRPY_PCC_VTEXTV_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZHRPY_PCC_VTEXTV'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZHRPY_PCC_VTEXTV-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHRPY_PCC_VTEXTV_EXTRACT
TOTAL = ZHRPY_PCC_VTEXTV_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZHRPY_PCC_VTEXTV-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZHRPY_PCC_VTEXTV'
...
TOTAL = ZHRPY_PCC_VTEXTV_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZHRPY_PCC_VTEXTV-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZHRPY_PCC_VTEXTV-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZHRPY_PCC_VTEXTV'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZHRPY_PCC_VTEXTV-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHRPY_PCC_VTEXTV_EXTRACT
TOTAL = ZHRPY_PCC_VTEXTV_TOTAL
