...
data: go_ehiupdate type ref to zusecl_m99_pcc_ehiupdate.

data gt_proc_jobslist type zusecl_m99_pcc_ehiupdate=>tty_proc_jobslist.
data gs_proc_jobslist type zusecl_m99_pcc_ehiupdate=>ty_proc_jobslist.
data gt_emplist type zusecl_m99_pcc_ehiupdate=>tty_emplist.
data gs_emplist type zusecl_m99_pcc_ehiupdate=>ty_emplist.
...
*
data: gt_fieldnames type table of zuseaustpy_pcc_fldnames.
data: gs_fieldnames type zuseaustpy_pcc_fldnames.
data: gt_jobs_fields type table of zuseaustpy_pcc_fldnames.
data: gt_emps_fields type table of zuseaustpy_pcc_fldnames.

* Selection Screen
selection-screen begin of block blk01 with frame title text-001.
parameters: p_procid type pyc_d_pyp-id obligatory
                          matchcode object zusehrpy_sh_pyp.
