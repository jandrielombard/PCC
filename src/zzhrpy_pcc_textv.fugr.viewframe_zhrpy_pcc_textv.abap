*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZHRPY_PCC_TEXTV
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZHRPY_PCC_TEXTV     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZHRPY_PCC_TEXTV'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZHRPY_PCC_TEXTV_EXTRACT
TOTAL = ZHRPY_PCC_TEXTV_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZHRPY_PCC_TEXTV'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZHRPY_PCC_TEXTV-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHRPY_PCC_TEXTV_EXTRACT
TOTAL = ZHRPY_PCC_TEXTV_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZHRPY_PCC_TEXTV-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZHRPY_PCC_TEXTV'
...
TOTAL = ZHRPY_PCC_TEXTV_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZHRPY_PCC_TEXTV-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZHRPY_PCC_TEXTV-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZHRPY_PCC_TEXTV'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZHRPY_PCC_TEXTV-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHRPY_PCC_TEXTV_EXTRACT
TOTAL = ZHRPY_PCC_TEXTV_TOTAL
