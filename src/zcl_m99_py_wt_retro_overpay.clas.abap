class zcl_m99_py_wt_retro_overpay definition
  public
...
CLASS ZCL_M99_PY_WT_RETRO_OVERPAY IMPLEMENTATION.
...
* Collect the data
    data: lo_cloned_chkobj type ref to zcl_m99_py_wt_retro_overpay.
