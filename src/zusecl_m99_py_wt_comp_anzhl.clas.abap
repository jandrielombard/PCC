class ZUSECL_M99_PY_WT_COMP_ANZHL definition
  public
...
CLASS ZUSECL_M99_PY_WT_COMP_ANZHL IMPLEMENTATION.
...
* Collect the data
    data: lo_cloned_chkobj type ref to zusecl_m99_py_wt_comp_anzhl.
