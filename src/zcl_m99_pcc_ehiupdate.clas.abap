class zcl_m99_pcc_ehiupdate definition
  public
  final
  create public .
...
* Employees list
    ...
    methods get_proc_jobslist
      exporting
        ...
        !et_emplist       type zcl_m99_pcc_ehiupdate=>tty_emplist
    ...
    class-methods add_employees_to_ehitbl
      changing
        !ct_emplist type zcl_m99_pcc_ehiupdate=>tty_emplist .
protected section.
...
CLASS ZCL_M99_PCC_EHIUPDATE IMPLEMENTATION.


  method add_employees_to_ehitbl.
* Add Employees to Event Handler Table
    data: ls_emplist type zcl_m99_pcc_ehiupdate=>ty_emplist.
...
* Filter out in active employees
    data lt_emplist type zcl_m99_pcc_ehiupdate=>tty_emplist.
    data ls_emplist type zcl_m99_pcc_ehiupdate=>ty_emplist.

    data lt_pypi_emplist type zcl_m99_pcc_ehiupdate=>tty_emplist.
    ...
    data lt_employee_status type zcl_m99_pcc_ehiupdate=>tty_employee_status.
...
* Update Reprocess status using Payroll Reprocess Time
    ...
    data lt_pay_process_time type zcl_m99_pcc_ehiupdate=>tty_emplist.
    data ls_pay_process_time type zcl_m99_pcc_ehiupdate=>ty_emplist.
...
* apply payroll run time condition
    ...
    data lt_pay_runtime type zcl_m99_pcc_utilities=>tty_payrun_time.
    data ls_pay_runtime type zcl_m99_pcc_utilities=>ty_payrun_time.
...
* Payroll Run Time
      call method zcl_m99_pcc_utilities=>get_employees_payroll_runtime
        exporting
          iv_abkrs    = lv_abkrs
          iv_inper    = lv_inper
...
* Jobs List
    data: lt_jobslist type zcl_m99_pcc_ehiupdate=>tty_proc_jobslist,
          ls_jobslist type zcl_m99_pcc_ehiupdate=>ty_proc_jobslist.
    data: lt_emplist type zcl_m99_pcc_ehiupdate=>tty_emplist,
          ls_emplist type zcl_m99_pcc_ehiupdate=>ty_emplist.
    data: lv_lines type i.
...
* Read Employee List from the Job Variants
    loop at lt_job_steps into ls_job_step.
      ...
      call method zcl_m99_pcc_utilities=>get_variant_pnpindex_list
        exporting
