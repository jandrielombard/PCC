...
*           |              |                              |             *
*-----------------------------------------------------------------------*
report zusehraurepy_pcc_vcat.

constants: gc_view         type vcl_name value 'ZUSE_PCC_VCAT',
...
data: gt_val   type table of pyd_d_tyt,
      ...
      gt_key   type table of zuse_pcc_vcat,
      gs_key   type zuse_pcc_vcat,
      gv_modif.
...
if gv_modif eq gc_action.
  modify zuse_pcc_vcat from table gt_key.
