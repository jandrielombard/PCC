class zcl_m99_py_wt_comp_betrg_per definition
  public
...
CLASS ZCL_M99_PY_WT_COMP_BETRG_PER IMPLEMENTATION.
...
* Collect the data
    data: lo_cloned_chkobj type ref to zcl_m99_py_wt_comp_betrg_per.
