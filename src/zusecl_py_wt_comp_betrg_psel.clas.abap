class ZUSECL_PY_WT_COMP_BETRG_PSEL definition
  public
...
CLASS ZUSECL_PY_WT_COMP_BETRG_PSEL IMPLEMENTATION.
...
* Collect the data
    data: lo_cloned_chkobj type ref to zusecl_py_wt_comp_betrg_psel.
