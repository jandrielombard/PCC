class ZUSECL_PYC_STT_STP2_GENERATION definition
  public
...
protected section.
  ...
  constants MC_SELECTION_CLS_STP2 type PYD_PAR_TYPE value 'ZUSECL_PYC_BPC_SELECT_STP2' ##NO_TEXT.
  constants MC_PARA_SELECTION_CLS_STP2 type PYD_PAR_TYPE value 'ZUSECL_PYC_BPC_PAR_SELECT_STP2' ##NO_TEXT.
  constants GCV_PAR_PARALLE type PYD_PAR_TYPE value 'PYP_INTERVAL' ##NO_TEXT.
  constants GCV_PAR_TEST_RUN type PYD_PAR_TYPE value 'ZUSE_TEST_RUN' ##NO_TEXT.
...
CLASS ZUSECL_PYC_STT_STP2_GENERATION IMPLEMENTATION.
