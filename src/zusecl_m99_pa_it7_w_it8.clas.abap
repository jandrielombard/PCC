class ZUSECL_M99_PA_IT7_W_IT8 definition
  public
...
public section.
  ...
  constants MC_DATES_MISMATCH type CHAR1 value 'A' ##NO_TEXT.
  constants MC_NO_SALARY_UPDATE type CHAR1 value 'B' ##NO_TEXT.
  constants MC_INFTY_0007 type INFTY value '0007' ##NO_TEXT.
  constants MC_INFTY_0008 type INFTY value '0008' ##NO_TEXT.
  protected section.
...
CLASS ZUSECL_M99_PA_IT7_W_IT8 IMPLEMENTATION.
...
* Execute Mode
  ...
  method GET_DISTINCT_WAGE_TYPES.
    ...
    do mc_number_of_wagetypes times.
      ...
      concatenate zusecl_m99_pa_it0008_comp_wt=>mc_field_prefix_amount lv_field_no into lv_field_val_name.
